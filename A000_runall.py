...
if l_mess:
    funcsms.send_telegram('Downloading <b>kfs</b> data from oracle and <b>running</b> tests.')
...
if funcdate.today_dayname() in "TueWedThuFriSat":
    ...
    try:
        ...
        if l_mail:
            funcmail.Mail('std_success_gmail', 'NWUIAPython:Success:B006_kfs_period_list',
...
if l_mess:
    funcsms.send_telegram('Completed downloading and running all tests.')