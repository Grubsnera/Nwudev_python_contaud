Select
    ...
    Case
        ...
        When Date(assi.ia_assi_startdate) < '2023-09-30'
    ...
    Case
        ...
        When Date(assi.ia_assi_finishdate) >= '2022-10-01' And Date(assi.ia_assi_finishdate) <= '2023-09-30'
...
Where
    ...
    (user.ia_user_active = '1' And
        ...
        assi.ia_assi_finishdate <= '2023-09-30')