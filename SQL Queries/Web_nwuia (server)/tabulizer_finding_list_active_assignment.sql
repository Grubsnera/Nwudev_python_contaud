Select
    ...
    Case
        ...
        Else Concat('<a title="Finding copy" href="index.php?option=com_rsform&view=rsform&formId=',
            ...
            find.ia_assi_auto, '" target="_blank" rel="noopener nofollow noreferrer">Delete</a>', ' | ', Concat('<a title="Finding report" href = "index.php?option=com_content&view=article&id=', find.ia_find_formview, '&hash=', find.ia_find_token, '" target="_blank" rel="noopener noreferrer nofollow">', 'View', '</a>'))
    End As actions,
    Case
