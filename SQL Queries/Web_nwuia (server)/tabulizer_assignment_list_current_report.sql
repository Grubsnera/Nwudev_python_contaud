...
Where
    ...
    assi.ia_assi_year = Year(Date_add(Now(), Interval 1 Year)) And
    ...
    -- (assi.ia_user_sysid = {user_id} And
    (assi.ia_user_sysid = 855 And
    assi.ia_assi_finishdate between Concat(Year(Date(Now())), '1001') And Concat(Year(Date_add(Now(), Interval 1 Year)), '0930') And
    user.ia_user_active = '1' and
    cate.ia_assicate_private = '0')
    Else
    (assi.ia_user_sysid = 855 And
    assi.ia_assi_year = Year(Date(Now())) And
    user.ia_user_active = '1' and
    cate.ia_assicate_private = '0') Or
    (assi.ia_user_sysid = 855 And
    assi.ia_assi_year < Year(Date(Now())) And
    ...
    cate.ia_assicate_private = '0') Or
    (assi.ia_user_sysid = 855 And
    assi.ia_assi_finishdate between Concat(Year(Date_add(Now(), Interval -1 Year)), '1001') And Concat(Year(Date(Now())), '0930') And
    user.ia_user_active = '1' and
    cate.ia_assicate_private = '0')
    End)
Group By
