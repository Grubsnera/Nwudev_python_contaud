Select
    ...
    Concat('<a href = "index.php?option=com_rsform&view=rsform&formId=10&fid=',find.ia_find_auto,'&hash=',find.ia_find_token,'" target="_blank" rel="noopener noreferrer">',find.ia_find_name,'</a>') As finding,
    Concat(Date(find.ia_find_editdate), ' ', Substr(MonthName(find.ia_find_editdate), 1, 3)) As dateedit,
    fist.ia_findstat_name As status,
    Concat('<a href = "index.php?option=com_content&view=article&id=',find.ia_find_formview,'&rid=',find.ia_find_auto,'">View</a>') As actions,
    Case
        When Count(reme.ia_findreme_auto) > 1
        Then Concat('<a href = "https://www.ia-nwu.co.za/index.php?option=com_rsform&view=rsform&formId=3">Add</a>','|',Concat(Cast(Count(reme.ia_findreme_auto) As Character),'requests'))
        When Count(reme.ia_findreme_auto) > 0
        Then Concat('<a href = "https://www.ia-nwu.co.za/index.php?option=com_rsform&view=rsform&formId=3">Add</a>','|',Concat(Cast(Count(reme.ia_findreme_auto) As Character),'request'))
