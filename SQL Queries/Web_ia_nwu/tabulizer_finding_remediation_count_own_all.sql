Select
    ...
    Concat(cate.ia_assicate_name, '(', type.ia_assitype_name, ')') As category_type,
    assi.ia_assi_year As year,
    Concat(assi.ia_assi_name, ' (', assi.ia_assi_auto, ')') As assignment,
    Concat('<a href = "index.php?option=com_rsform&view=rsform&formId=', find.ia_find_formedit, '&fid=', find.ia_find_auto, '&hash=', find.ia_find_token, '" target="_blank" rel="noopener noreferrer">', find.ia_find_name, ' (', find.ia_find_auto, ')', '</a>') As finding,
