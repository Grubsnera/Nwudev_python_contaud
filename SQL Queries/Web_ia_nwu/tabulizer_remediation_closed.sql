Select
    Concat(assi.ia_assi_name, '(', assi.ia_assi_auto, ') - ', find.ia_find_name, '(', find.ia_find_auto, ') (', assi.ia_assi_year, ')') As assignment_finding,
    ...
    date(reme.ia_findreme_editdate) As edited,
