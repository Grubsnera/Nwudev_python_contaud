Select
    ...
    Concat('<a href = "index.php?option=com_rsform&view=rsform&formId=14" target="_blank" rel="noopener noreferrer">',
    'Add', '</a>', ' | ', '<a href = "index.php?option=com_rsform&view=rsform&formId=', assi.ia_assi_formedit,
    '&aid=', assi.ia_assi_auto, '&hash=', assi.ia_assi_token, '&category=', assi.ia_assicate_auto,
    '" target="_blank" rel="noopener noreferrer">', 'Edit', '</a>', ' | ',
    '<a href = "index.php?option=com_rsform&view=rsform&formId=', assi.ia_assi_formdelete, '&aid=', assi.ia_assi_auto,
    '&hash=', assi.ia_assi_token, '" target="_blank" rel="noopener noreferrer">', 'Delete', '</a>', ' | ',
    '<a href = "index.php?option=com_content&view=article&id=', assi.ia_assi_formview, '&hash=', assi.ia_assi_token,
    '" target="_blank" rel="noopener noreferrer">', 'Report', '</a>') As Actions,
    Case
        When Count(find.ia_find_auto) > 1
        Then Concat('<a href = "https://www.ia-nwu.co.za/index.php?option=com_rsform&view=rsform&formId=9&aid=',
            assi.ia_assi_auto, '" target="_blank" rel="noopener noreferrer">Add</a>', '|',
            '<a href = "https://www.ia-nwu.co.za/index.php?option=com_content&view=article&id=26&rid=',
        ...
        Else Concat('<a href = "https://www.ia-nwu.co.za/index.php?option=com_rsform&view=rsform&formId=9&aid=',
            assi.ia_assi_auto, '" target="_blank" rel="noopener noreferrer">Add</a>')
    End As Findings
From
...
Where
    user.ia_user_name Like '%albert%' And
