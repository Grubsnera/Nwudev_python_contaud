...
def gl_test_transactions():
    ...
    *****************************************************************************"""
    ...
    if not l_run_professional_fee_student:
        ...
        so_curs.execute("DROP TABLE IF EXISTS X001aa_professional_fee_student")
        so_curs.execute("DROP TABLE IF EXISTS X001ab_findings")
        so_curs.execute("DROP TABLE IF EXISTS X001ac_get_previous")
        so_curs.execute("DROP TABLE IF EXISTS X001ad_add_previous")
        so_curs.execute("DROP TABLE IF EXISTS X001ae_new_previous")
        # so_curs.execute("DROP TABLE IF EXISTS X001ax_professional_fee_student")
