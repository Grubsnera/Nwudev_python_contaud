...
QUALIFICATION FEE TEST ABNORMAL TRANSACTION CONTACT (6 ABNORMAL TRANSACTION)
...
def student_fee(s_period='curr', s_year='0'):
    ...
    *****************************************************************************"""
    ...
    # TODO QUALIFICATION FEE TEST ABNORMAL TRANSACTION CONTACT Booked out for development
