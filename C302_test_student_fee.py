...
TEST REGISTRATION FEE CONTACT ZERO (V2.0.1)
...
QUALIFICATION FEE TEST ABNORMAL TRANSACTION CONTACT (V1.0.9)(6 ABNORMAL TRANSACTION)
QUALIFICATION FEE TEST OVERCHARGE CONTACT (V2.0.0)(2 VALID COLUMN)
SECONDARY QUALIFICATION FEE OVERCHARGE CONTACT (V2.0.1)(3 VALID COLUMN)
