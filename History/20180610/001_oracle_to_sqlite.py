...
funcfile.writelog("SCRIPT: 001_ORACLE_TO_SQLITE")
funcfile.writelog("----------------------------")
ilog_severity = 1
...
if ilog_severity >= 3:
    fl.write("IMPORTED: funcdate module"+"\r\n")
...
for row in db_reader:
    ...
    if row[0] == "DESC":
        ...
        funcfile.writelog("%t OPEN DATABASE: " + row[0])
        print("--------")
    ...
    for row in tb_reader:
        ...
        for result in ResultIter(so_cur.execute(ssql_str)):
            c_text = ""
            c_test = ""
            c_data = "("
            i = 0
