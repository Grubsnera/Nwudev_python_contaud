...
def Report_kfs_studdeb_tran():
    ...
    funcfile.writelog("SCRIPT: C021_REPORT_KFS_STUDDEB_TRAN")
    funcfile.writelog("------------------------------------")
    print("----------------------------")
    print("C021_REPORT_KFS_STUDDEB_TRAN")
    print("----------------------------")
    ilog_severity = 1
    ...
    funcfile.writelog("---------------------------------------")
    funcfile.writelog("COMPLETED: C021_REPORT_KFS_STUDDEB_TRAN")
