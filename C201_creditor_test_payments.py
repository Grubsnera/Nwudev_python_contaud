...
def creditor_test_payments():
    ...
    *****************************************************************************"""
    ...
    if not l_run_quote_split:
        ...
        so_curs.execute("DROP TABLE IF EXISTS X001ea_a_vendor_quote_split_payment")
        so_curs.execute("DROP TABLE IF EXISTS X001ea_b_vendor_quote_split_payment")
        so_curs.execute("DROP TABLE IF EXISTS X001ea_vendor_quote_split_payment")
        so_curs.execute("DROP TABLE IF EXISTS X001eb_finding")
        so_curs.execute("DROP TABLE IF EXISTS X001ed_addprev")
        so_curs.execute("DROP TABLE IF EXISTS X001ee_newprev")
        # so_curs.execute("DROP TABLE IF EXISTS X001ex_vendor_quote_split_payment")
