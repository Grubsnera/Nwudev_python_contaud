...
def creditor_test_payments():
    ...
    *****************************************************************************"""
    ...
    # TODO Develop script to test small split payments

    # TODO Remove after first run on system to clean out unused files
    ...
    From
        ...
        %FILEP%a_b_%FILEN% b On b.ORG_NM = a.ORG_NM
                ...
                And julianday(b.PMT_DT) - julianday(a.PMT_DT) <= 7
